...
/**
 * redis使用 https://blog.csdn.net/sinat_22797429/article/details/89196933
 * redis方法说明
 * 
 * @author ASUS
 *
...
public class RedisController {
	...
	public static void main(String[] args) {
		try {
			InetAddress ids = InetAddress.getLocalHost();// 获取本地主机信息

			System.out.println(ids.getHostName());
			System.out.println(ids.getHostAddress());
			System.out.println(ids.getCanonicalHostName());
